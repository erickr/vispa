...
/**
 * Everyone who signed up before families existed gets one of their own, named after their
...
return new class extends Migration
{
    public function up(): void
    {
        User::query()->lazyById()->each(
            fn (User $user) => app(CreatePersonalFamily::class)->handle($user)
        );
    }

    public function down(): void
    {
        // The teams tables are dropped by their own migrations.
    }
};
